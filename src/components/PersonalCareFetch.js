...
let filteredItems = [];
class PersonalCareFetch extends Component {
	state = {
		loading: true,
		arr: [],
		arr1: [],
	...
	async componentWillMount() {
		axios({
			method: 'GET',
			url: 'http://192.168.43.228:3090/personalCare'
		})
			.then(res => {
...
export default connect(mapStateToProps, { cartChanged })(PersonalCareFetch);
